...
export default function PaperPlane() {
  return (
    <motion.div
      className="max-lg:hidden absolute left-[35%] top-[38%] z-50 "
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        ...
        <polygon
          className="st2"
          points="1434.4,533.5 1451.9,421.5 1490.3,474.2"
        />
        <g>
          <g>
            ...
            <path
              className="st4"
              d="M1368.3,577.8c-62.6,55.1-247.4,199.7-416.4,156.1c-207.5-53.4-166.3-275.2-43.8-274.8S1105.5,673,1039.5,814    s-270,243-552.1,171c-229.3-58.5-419-299.7-466.8-364.9"
              fill="yellow"
            />
